...
#
# Two neighbourhood sizes are used by default. The small one describes the
# building's own block, the large one the wider district, and the difference
# between them says whether a building sits on the edge of a damaged area or
# deep inside it.
# --------------------------------------------------------------------------
...
def neighbour_features(xy, scores, ks=(8, 32)):
    ...
    scores: the first-stage model's probability for each building.
